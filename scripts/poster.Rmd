...
dotplot <- ggplot(st_binary, aes(x = percent_total, y = forcats::fct_reorder(st, percent_total))) +
    ...
    geom_point(aes(color = profession), size = 2)+
    geom_text(aes(x=percent_total,
                  y=st,
                  label = round(percent_total,0),
                  color = profession),
               nudge_x = 2, size = 5, family = "sans",
              show.legend = FALSE)+
   ...
   theme_minimal()+
    labs(
        ...
        subtitle = "Of all public school teachers, only 21% identify as teachers of color",
...
#ggpreview(height = 11, width = 9, unit = "in")
```
